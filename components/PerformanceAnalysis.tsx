    ...
    return (
        <div className="space-y-8 animate-fade-in">
            <div className="bg-white border border-slate-200 rounded-xl p-6">
                <h2 className="text-xl font-bold text-indigo-600 mb-4">Simulated Performance (Last Week)</h2>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                    {data.pastMetrics.map(metric => (
                        <div key={metric.title} className="bg-slate-50 p-4 rounded-lg border border-slate-200">
                            <p className="text-sm font-semibold text-slate-700">{metric.title}</p>
                            <p className="text-xs text-slate-500 mb-3">{metric.type}</p>
                            <div className="flex justify-around text-slate-600 text-sm">
            ...
            <div>
                <h2 className="text-xl font-bold text-indigo-600 mb-4 text-center">This Week's Data-Driven Plan</h2>
